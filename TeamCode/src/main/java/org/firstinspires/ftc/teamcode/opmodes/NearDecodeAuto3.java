...
@Autonomous(name = "DECODE Autonomous (Near, 3 gate hits)", preselectTeleOp = "DECODE TeleOp")
public class NearDecodeAuto3 extends BaseDecodeAuto {
    ...
    protected void computePoses() {
        ...
        middleSpikeControlPose1 = alliancePose(new Pose(49, 78.5));
        middleSpikeControlPose2 = alliancePose(new Pose(62, 58));
    ...
    protected void stateMachine() {
        switch ((PathState) pathState) {
            ...
            case WAIT_AND_OPEN_GATE:
                robot.intake(1, 0.5);
                if (Robot.DataPasser.hasElapsed(1.25)) {
